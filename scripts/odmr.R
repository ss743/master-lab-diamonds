...
range_013s <- c(2.84,2.865)
range_013s2 <- c(2.87,2.885)
fit_013s <- fgausfit(spec_013,range_013s)
fit_013s2 <- fgausfit(spec_013,range_013s2)
label_013s=data.frame(x=c(fit_013s['mu','Estimate'],fit_013s2['mu','Estimate']),y=c(0.004,0.003),text=c(sprintf("f1=(%0.4f+-%0.4f) s",fit_013s['mu','Estimate'],fit_013s['mu','Std. Error']),sprintf("f2=(%0.4f+-%0.4f) s",fit_013s2['mu','Estimate'],fit_013s2['mu','Std. Error'])))
plot_spec(spec_013) + plotgaus(fit_013s,range_013s) + plotgausline(fit_013s,0.01,-0.005) + plotgaus(fit_013s2,range_013s2) + plotgausline(fit_013s2,0.01,-0.005) + 
...
range_014s <- c(2.78,2.82)
range_014s2 <- c(2.82,2.85)
range_014s3 <- c(2.885,2.91)
range_014s4 <- c(2.92,2.94)
...
label_014s=data.frame(x=c(fit_014s['mu','Estimate'],fit_014s2['mu','Estimate'],fit_014s3['mu','Estimate'],fit_014s4['mu','Estimate']),y=c(0.004,0.003,-0.003,-0.004),text=c(sprintf("f1=(%0.4f+-%0.4f) s",fit_014s['mu','Estimate'],fit_014s['mu','Std. Error']),sprintf("f2=(%0.4f+-%0.4f) s",fit_014s2['mu','Estimate'],fit_014s2['mu','Std. Error']),sprintf("f3=(%0.4f+-%0.4f) s",fit_014s3['mu','Estimate'],fit_014s3['mu','Std. Error']),sprintf("f4=(%0.4f+-%0.4f) s",fit_014s4['mu','Estimate'],fit_014s4['mu','Std. Error'])))
plot_spec(spec_014) + plotgaus(fit_014s,range_014s) + plotgausline(fit_014s,0.01,-0.005) + 
                      plotgaus(fit_014s2,range_014s2) + plotgausline(fit_014s2,0.01,-0.005) + 
                      plotgaus(fit_014s3,range_014s3) + plotgausline(fit_014s3,0.01,-0.005) + 
                      plotgaus(fit_014s4,range_014s4) + plotgausline(fit_014s4,0.01,-0.005) + 
...
range_015s <- c(2.74,2.76)
range_015s2 <- c(2.84,2.88)
#range_015s3 <- c(2.885,2.91)
range_015s3 <- c(2.92,2.94)
...
label_015s=data.frame(x=c(fit_015s['mu','Estimate'],fit_015s2['mu','Estimate'],fit_015s3['mu','Estimate']),y=c(0.0045,0.0035,0.0025),text=c(sprintf("f1=(%0.4f+-%0.4f) s",fit_015s['mu','Estimate'],fit_015s['mu','Std. Error']),sprintf("f2=(%0.4f+-%0.4f) s",fit_015s2['mu','Estimate'],fit_015s2['mu','Std. Error']),sprintf("f3=(%0.4f+-%0.4f) s",fit_015s3['mu','Estimate'],fit_015s3['mu','Std. Error'])))
plot_spec(spec_015) + plotgaus(fit_015s,range_015s) + plotgausline(fit_015s,0.01,-0.005) + 
  plotgaus(fit_015s2,range_015s2) + plotgausline(fit_015s2,0.01,-0.005) + 
  plotgaus(fit_015s3,range_015s3) + plotgausline(fit_015s3,0.01,-0.005) + 
